  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: [
        Container(
          padding:
              EdgeInsets.only(right: 18.w, left: 18.w, top: 25.h, bottom: 18.h),
              ...
              Row(
                ...
                children: [
                  InkWell(
                      ...
                      child: Image.asset(AppImage.drawer, scale: 22)),
                  SizedBox(width: 15.w),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ToggleButtons(
                    ...
                    children: [
                      ToggleButton(isSelected: isSelected[0], text: "Recipes"),
                      ToggleButton(
                          isSelected: isSelected[1], text: "My Kitchens"),
                      ToggleButton(isSelected: isSelected[2], text: "Workout"),
                    ],
                    onPressed: (int index) {
                      setState(() {
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Search Kitchen type/Dish Name",
